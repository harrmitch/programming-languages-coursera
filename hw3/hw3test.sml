...
val test1_de = only_capitals ["A","B","C"] = ["A","B","C"]

val test2_de = longest_string1 ["A","bc","C"] = "bc"

val test3_de = longest_string2 ["A","bc","C"] = "bc"

val test4a_de = longest_string3 ["A","bc","C"] = "bc"

val test4b_de = longest_string4 ["A","B","C"] = "C"

val test5_de = longest_capitalized ["A","bc","C"] = "A"

val test6_de = rev_string "abc" = "cba"

val test7_de = first_answer (fn x => if x > 3 then SOME x else NONE) [1,2,3,4,5] = 4

val test8_de = all_answers (fn x => if x = 1 then SOME [x] else NONE) [2,3,4,5,6,7] = NONE

val test9a_de = count_wildcards Wildcard = 1

val test9b_de = count_wild_and_variable_lengths (Variable("a")) = 1

val test9c_de = count_some_var ("x", Variable("x")) = 1

val test10_de = check_pat (Variable("x")) = true

val test11_de = match (Const(1), UnitP) = NONE

val test12_de = first_match Unit [UnitP] = SOME []
